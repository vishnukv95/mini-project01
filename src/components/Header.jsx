...
const handleSignUpClick=()=>{
 ...
 return (
    <header className="flex z-50 justify-around items-center bg-white shadow-md fixed top-0 left-0 w-full">
    <a href="/"> 
     ...
     <div className="flex items-center ">
       <input className="hidden md:block w-[400px] outline-green-300 bg-green-100 p-2 rounded-l-lg" type="text" placeholder="Search" />
      ...
      <div className="flex justify-center items-center gap-1 ">
       ...
       { isLoggedin ?
        ...
        (<div className="flex justify-center items-center"> 
          <button onClick={handleLoginClick}  type="button" className="text-green-600  outline-2 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300  font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Log in</button>
          <button onClick={handleSignUpClick}  type="button" className="text-white bg-gradient-to-l from-green-500 via-green-600 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300  font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Sign up</button></div>)}
         </div>
          <div>
